...
| Ubuntu 24.04+ amd64 | `entcoin_1.5.3_amd64.deb` |
...
`SHA256SUMS-linux.txt` 校验。GitHub 还为 v1.5.3 产物发布构建来源证明。
...
v1.5.3 继承 v1.2.1 已审计的共识规则，并通过全量测试、竞态检测、
...
- [安全策略](SECURITY.md)
- [v1.5.3 中英文发布说明](RELEASE_NOTES.md)
