...
Entcoin v1.5.4 is a compact proof-of-work mainnet packaged as a Windows and
...
> activated at block 125555. Every v1.2.0 node and miner must install v1.5.4.

## What v1.5.4 includes
...
needed. The current v1.5.4 release may be unsigned, so Windows SmartScreen may show
...
`.entwallet` backup. Start v1.5.4 to create the mainnet directory, then use the
