...
Entcoin v1.5.0 is a compact proof-of-work mainnet packaged as a Windows and
...
> activated at block 125555. Every v1.2.0 node and miner must install v1.5.0.

## What v1.5.0 includes
...
needed. The current v1.5.0 release may be unsigned, so Windows SmartScreen may show
...
```bash
sudo apt install ./entcoin_1.5.0_amd64.deb
entcoin
```
...
`.entwallet` backup. Start v1.5.0 to create the mainnet directory, then use the
