...
Entcoin v1.2.2 uses the compatibility identity `entropy-mainnet-v1`. The word
...
| Version | Status |
| --- | --- |
| `1.2.2` | Current mainnet release; required before block 125555 |
| `1.2.1` | Consensus-compatible; update recommended for the Windows updater fix |
...
| `1.0.x` | Superseded; upgrade to v1.2.2 |
...
- v1.2.2 Windows binaries may be unsigned and trigger SmartScreen. Release CI
...
- Network privacy is not a goal of v1.2.2. Peers observe IP addresses, timing, and
