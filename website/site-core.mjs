export const FALLBACK_RELEASE_URL =
  "https://github.com/HONG-LOU/entcoin/releases/tag/v1.5.4";
...
const en = {
  ...
  "entpay.eyebrow": "New in v1.5.4 / Agent payments",
  ...
  "download.boundary":
    "v1.2.0 is superseded. Upgrade to v1.5.4 before block 125555 and verify the published checksums.",
...
const zh = {
  ...
  "entpay.eyebrow": "v1.5.4 新能力 / Agent 支付",
  ...
  "download.boundary":
    "v1.2.0 已被替代。请在高度 125555 前升级到 v1.5.4，并核对官方 SHA-256。",
