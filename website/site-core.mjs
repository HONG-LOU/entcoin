export const FALLBACK_RELEASE_URL =
  "https://github.com/HONG-LOU/entcoin/releases/tag/v1.5.5";
...
const en = {
  ...
  "entpay.eyebrow": "New in v1.5.5 / Agent payments",
  ...
  "download.boundary":
    "v1.2.0 is superseded. Upgrade to v1.5.5 before block 125555 and verify the published checksums.",
...
const zh = {
  ...
  "entpay.eyebrow": "v1.5.5 新能力 / Agent 支付",
  ...
  "download.boundary":
    "v1.2.0 已被替代。请在高度 125555 前升级到 v1.5.5，并核对官方 SHA-256。",
